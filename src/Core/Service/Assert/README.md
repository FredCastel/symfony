...
<?php
use Core\Service\Assertion;
use Core\Service\AssertionFailedException;

try {
    Assertion::integer($value, "The pressure of gas is measured in integers.");
} catch(AssertionFailedException $e) {
    // error handling
    $e->value; // the value that caused the failure
...
use Core\Service\Assertion as BaseAssertion;
