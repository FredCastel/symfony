...
final class SetAccountInitialBalanceVoter extends CommandIdVoter
{
    ...
    protected function internalVoter($id): void
    {
        ...
        if (!$entity->canSetInitialBalance()) {
            $notif = new Notification();
            $notif->addMessage(new InformationMessage('SetAccountInitialBalance', "Command can't be applied"));
