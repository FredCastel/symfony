...
use Banking\Application\Command\Account\CloseAccount\CloseAccountRequest;
...
final class CloseAccountProcessor extends CommandProcessor
{
    public static function usedCommandRequests(): array
    {
        return [CloseAccountRequest::class];
    }
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = [])
    {
        ...
        $command = new CloseAccountRequest(
            id: $id,
